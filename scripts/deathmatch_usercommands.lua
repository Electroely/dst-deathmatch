...
AddUserCommand("setarena", {
    ...
    voteresultfn = VoteUtil.DefaultMajorityVote,
    serverfn = function(params, caller)
		local arenas = { [1]="atrium", [2]="desert", [3]="pigvillage", [4]="random", atrium="atrium", desert="desert", pigvillage="pigvillage", spring="spring", malbatross = "malbatross", grotto = "grotto", random="random" }
		local dm = G.TheWorld.components.deathmatch_manager
