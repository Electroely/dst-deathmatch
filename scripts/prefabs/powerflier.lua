...
local FIND_TARGET_NOTAGS = { "playerghost" }
...
local function SetPowerup(inst, powerup)
...
local function fn()
    ...
    inst.components.health:SetMaxHealth(TUNING.LIGHTFLIER.HEALTH * 3)
    ...
    inst.components.formationfollower.formation_type = "powerflier"
	...
	inst.SetPowerup = SetPowerup
	
	MakeHauntablePanic(inst)
	
	inst:DoTaskInTime(0, function()
		if inst.powerup == nil then
			inst:SetPowerup(GetRandomItem(powerups))
		end
	end)
...
return Prefab("powerflier", fn, assets, prefabs)