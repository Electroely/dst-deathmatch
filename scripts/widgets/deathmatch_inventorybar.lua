...
local Inv = Class(Widget, function(self, owner)
	...
	self.bg = self.root:AddChild(Image("images/deathmatch_inventorybar.xml", "deathmatch_inventorybar.tex"))
...
local function RebuildLayout(self, inventory, overflow, do_integrated_backpack, do_self_inspect)
	...
	for k = 1, 4 do
		...
		slot.base_scale = 1.5
		slot.highlight_scale = 1.8
		slot:SetScale(1.5,1.5,1.5)
