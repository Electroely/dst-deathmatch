return {
	...
	FORGE_MAGE_SUMMON_DAMAGE_PENALTY = 0.66,
	FORGE_MAGE_SUMMON_DAMAGE_PENALTY_HITS = 3,
	FORGE_MAGE_SUMMON_HEALTH = 100,
	FORGE_MAGE_HEALBLOOMS_DEFENSE = 0.5,

	FIREBOMB_MELEE_DAMAGE = 25,
	FIREBOMB_MELEE_EXPLOSION_DAMAGE = 150,
	FIREBOMB_THROW_EXPLOSION_DAMAGE = 200,
